...
static inline
double get_sum(double *data, int samples)
{
    int i;
    double sum = 0;
...
static inline
double get_avg(double *data, int samples)
{
    int i;
    double sum = 0;
...
static inline
double get_max(double *data, int samples)
{
    int i;
    double max = 0;
...
static inline
double get_min(double *data, int samples)
{
    int i;
    double min = DBL_MAX;
...
static inline
double get_cpw(double *data, int samples, int div)
{
    int i;
    double sum = 0;
...
static inline
double get_cpu_work(double *data, int samples, int mtc)
{
    int i;
    double sum = 0;
