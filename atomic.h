 ...
 *
 * Parts copied from:
 *   T. E. Hart. "Making Lockless Synchronization Fast: Performance Implications of Memory Reclamation". 
 *
...
#define atomic_cmpxchg4(ptr, oldval, newval) __sync_val_compare_and_swap( ptr, oldval, newval)
...
//static inline unsigned long
#define atomic_xadd4(ctr, addend) \
			__sync_fetch_and_add(ctr, addend)
